...
export PEER1_MANUFACTURER_CA=${PWD}/organizations/peerOrganizations/manufacturer.pharma-network.com/peers/peer1.manufacturer.pharma-network.com/tls/ca.crt
export PEER1_DISTRIBUTOR_CA=${PWD}/organizations/peerOrganizations/distributor.pharma-network.com/peers/peer1.distributor.pharma-network.com/tls/ca.crt
export PEER1_RETAILER_CA=${PWD}/organizations/peerOrganizations/retailer.pharma-network.com/peers/peer1.retailer.pharma-network.com/tls/ca.crt
export PEER1_TRANSPORTER_CA=${PWD}/organizations/peerOrganizations/transporter.pharma-network.com/peers/peer1.transporter.pharma-network.com/tls/ca.crt
export PEER1_CONSUMER_CA=${PWD}/organizations/peerOrganizations/consumer.pharma-network.com/peers/peer1.consumer.pharma-network.com/tls/ca.crt
...
setGlobalsCLI() {
  ...
  if [ $USING_ORG == "manufacturer" ]; then
    ...
    export CORE_PEER_ADDRESS=peer1.manufacturer.pharma-network.com:14051
  elif [ $USING_ORG == "distributorpeer1" ]; then
    export CORE_PEER_ADDRESS=peer1.distributor.pharma-network.com:13051
  elif [ $USING_ORG == "retailerpeer1" ]; then
    export CORE_PEER_ADDRESS=peer1.retailer.pharma-network.com:15051
  elif [ $USING_ORG == "transporterpeer1" ]; then
    export CORE_PEER_ADDRESS=peer1.transporter.pharma-network.com:16051 
  elif [ $USING_ORG == "consumerpeer1" ]; then
    export CORE_PEER_ADDRESS=peer1.consumer.pharma-network.com:19051    
  elif [ $USING_ORG -eq 3 ]; then
...
parsePeerConnectionParameters() {
  ...
  while [ "$#" -gt 0 ]; do
    ...
    if [ $1 == "manufacturer" ]; then
     ...
     elif [ $1 == "manufacturerpeer1" ]; then
      TLSINFO=$(eval echo "--tlsRootCertFiles \$PEER1_MANUFACTURER_CA")
    elif [ $1 == "retailerpeer1" ]; then
      TLSINFO=$(eval echo "--tlsRootCertFiles \$PEER1_RETAILER_CA")
    elif [ $1 == "transporterpeer1" ]; then
      TLSINFO=$(eval echo "--tlsRootCertFiles \$PEER1_TRANSPORTER_CA")
    elif [ $1 == "distributorpeer1" ]; then
      TLSINFO=$(eval echo "--tlsRootCertFiles \$PEER1_DISTRIBUTOR_CA")
    elif [ $1 == "consumerpeer1" ]; then
      TLSINFO=$(eval echo "--tlsRootCertFiles \$PEER1_CONSUMER_CA")      
    else
